...
string Alumno::serializar() {
    string nombreClase = typeid(*this).name();
    return nombreClase+"|"+codigo+"|"+nombre+"|"+apellidoPaterno+"|"+apellidoMaterno;
}

string Alumno::csv() {
    return codigo+","+apellidoPaterno+","+apellidoPaterno+","+nombre;
}
